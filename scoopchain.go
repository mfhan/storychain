...
var scoopIndexStr = "_scoopindex"             //name for the key/value that will store a list of all known stories

// var openStoriesStr = "_openstories"               //name for the key/value that will store all open trades

type Scoop struct{
    Name string `json:"name"`   //the fieldtags are needed to keep case from bouncing around
    Urgency int `json:"immediate"`
    Size int `json:"size"`
    User int `json: "user"`
...
type Description struct{
    Importance string `json:"pulitzer"`
    Size int `json:"size"`
    Urgency int `json:"immediate"`
    Authors string `json:"authors"`
}

// type openStories struct{
...
//     OpenStories []AnOpenStory `json:"open_stories"`
// }
...
func (t *SimpleChaincode) Invoke(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
    ...
    } else if function == "init_scoop" {                                   //create a new story
        return t.init_scoop(stub, args)
    } else if function == "set_user" {                                      //change owner of a story
